...
import { View, Image, StyleSheet, FlatList, Text, TouchableOpacity, Modal, TextInput, ActivityIndicator, Platform, Keyboard, ScrollView, Linking, RefreshControl } from 'react-native';
            ...
            <View style={styles.container}>
                ...
                <View style={styles.lotteryList}>
                    {loadingPoints ? (
                        ...
                        <View>
                            {pointDetails.map((item: any, k: number) => (
                                <View key={k}>
                    ...
                    <View style={styles.modalContainerTerms}>
                        <View style={styles.modalContentTerms}>
                            ...
                            <View>
                                ...
                                <TouchableOpacity style={[styles.acceptButton, { backgroundColor: isChecked ? 'blue' : 'gray' }]} disabled={!isChecked} onPress={handleAccept}>
