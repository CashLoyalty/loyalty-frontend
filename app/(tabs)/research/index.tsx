...
import { View, Text, StyleSheet, ListRenderItem, FlatList, Image } from 'react-native';
...
const ResearchInfoData: ResearchItem[] = [
  { id: '1', imgUrl: require('@/assets/icons/researchItem1.png'), researchTitle: 'Lipton Tea', score: '+150 оноо', question: '6 асуулт' },
  { id: '2', imgUrl: require('@/assets/icons/researchItem2.png'), researchTitle: 'Pepsi Black', score: '+210 оноо', question: '2 асуулт' },
  { id: '3', imgUrl: require('@/assets/icons/researchItem3.png'), researchTitle: 'Pepsi Vanilla', score: '+100 оноо', question: '5 асуулт' },
]
    ...
    <View style={styles.researchItem}>
      <View style={styles.researchRowContainer}>
        <View style={styles.researchImgContainer}>
          <Image source={item.imgUrl} style={{width:155,height:156,borderWidth:1,borderColor:Colors.primaryColor,borderRadius:10}}/>
        </View>
        <View style={styles.researchInfoContainer}>
          ...
          <View style={styles.infoSection2}>
            ...
            <View style={styles.questionContainer}>
              ...
              <Text style={{fontSize: 14, color: Colors.primaryColor, marginLeft: 10}}>{item.question}</Text>
            </View>
        </View>
        </View>
      </View>
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.emptyImageContainer}>
            <Image source={require('@/assets/images/emptyResearch.png')} style={styles.emptyImage}/>
